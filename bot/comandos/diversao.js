...
export const diversao = async(c, mensagemBaileys, botInfo) => {
    ...
    try {
        switch(comandoSemPrefixo){
            ...
            case 'teclado':
                try{
                    const mascoteFotoURL = "https://media.licdn.com/dms/image/v2/D4D22AQGC4gkeYV8tEg/feedshare-shrink_1280/B4DZQEmAvkGkAk-/0/1735243869134?e=1739404800&v=beta&t=L4XxIAMignaN3w4QXaW5f-JXe006Yk2fRdr-gi6N4co"
                    await socket.responderArquivoUrl(c, tiposMensagem.imagem,id_chat, mascoteFotoURL, '800 Pila 💀💀💀', mensagem)
                } catch(err){
                    throw err
                }
                break 
