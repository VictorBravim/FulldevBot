export function comandosInfo(botInfo){
    ...
    const comandos = {
        ...
        diversao: {
            teclado: {
                descricao: '',
                guia: `Ex: *${prefixo}teclado* - Exibe o inigualável e onipotente teclado de 800.\n`,
                msgs: {
                    resposta: '800 Pila 💀💀💀'
                }
            },
        ...
        grupo: {
            ...
            bcmd: {
                ...
                msgs: {
                    resposta_titulo: "🔒 *Comandos bloqueados* 🔒\n\n",
                    resposta_variavel: {
                        ja_bloqueado: " Os comandos já estão bloqueados.\n",
                        bloqueado_sucesso: "",
            ...
            dcmd: {
                ...
                msgs: {
                    resposta_titulo: "🔓 *Comandos Desbloqueados* 🔓\n\n",
                    resposta_variavel: {
                        desbloqueado_sucesso: "",
