    ...
    try{
        switch(comandoSemPrefixo){
            ...
            case `meusdados`:
                ...
                case `menu`:
                    try {
                        // Impede o uso do comando se o usuário não for administrador em grupos
                        if (mensagem_grupo && !usuario_admin) return;
                        ...
                        // Gera a resposta com base no status do limite diário
                        if (botInfo.limite_diario.status) {
                            dadosResposta = criarTexto(
                                comandos_info.info.menu.msgs.resposta_limite_diario,
                                nomeUsuario,
                                dadosUsuario.comandos_dia,
                                maxComandosDia,
                                tipoUsuario,
                                totalComandos
                            );
                            ...
                            dadosResposta = criarTexto(
                                comandos_info.info.menu.msgs.resposta_comum,
                                nomeUsuario,
                                tipoUsuario,
                                totalComandos
                            );
                        ...
                        // Verifica se há argumentos adicionais para o comando
                        if (!args.length) {
